...
import type { TenderBootstrap, TxState } from "@/lib/types";
...
export async function readProtocolBootstrap(): Promise<TenderBootstrap> {
  ...
  return result as unknown as TenderBootstrap;
}
